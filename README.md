...
## About the Developer
I am a Business Data Analyst with over 3 years of experience in translating complex business requirements into actionable, data-driven insights. My expertise lies in SQL, Python, and cloud-based analytics platforms, with a focus on improving operational efficiency and supporting executive decision-making. This project reflects my work in real-time data processing and my interest in building scalable analytics solutions using Apache Spark and Kafka.